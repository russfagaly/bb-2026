...
<style>
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  ...
  /* ── STAT PILLS ── */
  .pill {{ background:#f8fafc; border-radius:7px; padding:5px 2px; text-align:center; }}
  .pill-val {{ font-size:12px; font-weight:800; color:#0f2744; line-height:1; }}
  .pill-lbl {{ font-size:7px; color:#94a3b8; font-weight:600; text-transform:uppercase; margin-top:2px; letter-spacing:.2px; }}
  ...
  .pills-key {{ display:grid; grid-template-columns:repeat(4,1fr); gap:4px; margin-bottom:5px; }}
  .pills-counts {{ display:grid; grid-template-columns:repeat(4,1fr); gap:4px; margin-bottom:7px; }}
